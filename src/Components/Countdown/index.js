      ...
      <section className="hero is-dark is-bold is-fullheight has-text-centered">
        <div className="hero-body">
          <div className="container">
            <h1 className="title">{submittedDate.format("LL")} is coming!</h1>
            <div className="section">
              <Timer duration={duration} />
            </div>
            <Datepicker onDateSubmit={this.handleDateSubmit} />
            <Controls pause={paused} onPauseToggle={this.handleTogglePause} />
            <section className="section">
              <p>{currentDate.format("LLLL")}</p>
            </section>
          </div>
        </div>
      </section>
